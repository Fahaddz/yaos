...
This document describes the current recovery model. For the proposed next
model, see the [Recovery snapshot redesign RFC](../rfcs/recovery-snapshot-redesign.md).
